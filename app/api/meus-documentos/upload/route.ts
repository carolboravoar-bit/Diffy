...
export async function POST(request: NextRequest) {
  ...
  const storage_path = `${user.id}/${Date.now()}-${arquivo.name}`;
        ...
        messages: [
          {
            ...
            content: [
              ...
              { type: "text", text: "Extraia todo o conteúdo textual deste documento de forma fiel. Preserve a estrutura. Não adicione comentários." },
            ],
          },
        ],
      });
